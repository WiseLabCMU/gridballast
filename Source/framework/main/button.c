...
void disable_mcp_intr() {
    ...
    updateRegisterBit(11, 0, MCP23017_GPINTENA, MCP23017_GPINTENB);
}
...
void enable_mcp_intr() {
    ...
    updateRegisterBit(11, 1, MCP23017_GPINTENA, MCP23017_GPINTENB);
}
...
void button_init_task( void ) {
    ...
    pinMode(11,GPIO_MODE_INPUT);
    setupInterruptPin(11 ,GPIO_INTR_HIGH_LEVEL);    
    
    //esp32 interrupt initialization on GPIO4
    gpio_set_intr_type(4, GPIO_INTR_LOW_LEVEL);       
