...
void RegionCN779ComputeRxWindowParameters( int8_t datarate, uint8_t minRxSymbols, uint32_t rxError, RxConfigParams_t *rxConfigParams )
{
    ...
    //TODO_Sharan - check the parameter 0
    RegionCommonComputeRxWindowParameters( tSymbol, minRxSymbols, rxError, 0, &rxConfigParams->WindowTimeout, &rxConfigParams->WindowOffset );
}
